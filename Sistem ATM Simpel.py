    ...
    while (running):
        ...
        if opsi == 1:
            ...
            for i in range(0, len(dataRekening)):
                if username == dataRekening[i][
                        'Pengguna'] and login == dataRekening[i]['PIN']:
                    user = dataRekening[i]
                        ...
                        if chosen == 1:
                            ...
                            if transferchosen == 1:
                                if (user["antrian_transfer"].isFull()):
                                    print(
                                        'Maximal Transaksi Anda Sudah Melebihi Maksimum, silahkan tunggu beberapa saat lagi'
                                    )
                                    ...
                                    rekDituju = input(
                                        'Inputkan Rekening yang dituju : ')
                                    saldoDikirim = int(
                                        input(
                                            'Inputkan Saldo yang ditransfer : '
                                        ))
                                    userDituju = ''

                                    for i in range(0, len(dataRekening)):
                                        if rekDituju == dataRekening[i][
                                                'Nomor Rekening']:
                                            userDituju = dataRekening[i]

                                    if userDituju == '':
                                        print(
                                            'User tidak ditemukan, silahkan input dengan benar'
                                        )

                                    if userDituju == user:
                                        print(
                                            'User yang dituju tidak boleh sama dengan punya anda'
                                        )
                                        ...
                                        print(
                                            f' Atas Nama : {userDituju["Pengguna"]}'
                                        )
                                        print(
                                            f' Nomor Rekening : {userDituju["Nomor Rekening"]}'
                                        )
                                        print(
                                            f' Nominal Transfer : {saldoDikirim}'
                                        )
                                        print(
                                            '-------------------------------------------------'
                                        )
                            ...
                            saldoDitambahkan = int(
                                input(
                                    'Inputkan Saldo yang akan ditambahkan : '))

                            if (user["antrian_transfer"].isFull()):
                                os.system('cls')
                                print(
                                    'Kuota transaksi anda sudah penuh, harap tunggu beberapa saat lagi.'
                                )
                                time.sleep(2)
                            ...
                            saldoDitarik = int(
                                input('Inputkan Saldo yang akan ditarik : '))
                            ...
                            print('Data Anda')
                            print(
                                f'Nomor Rekening Anda : {user["Nomor Rekening"]}'
                            )
                            ...
                            print(
                                f'Kuota transfer yang tersedia {user["antrian_transfer"].size - len(user["antrian_transfer"].queue)}'
                            )
                            time.sleep(5)
            ...
            print(
                f'Registrasi Berhasil dengan username : {pengguna},  pin : {pinpenggunabaru}, nomor rekening : {norekbaru}'
            )
            time.sleep(30)
